...
import TransitionBox from './components/Transition.vue'
  ...
  <div id="hero">
    ...
    <main>
      ...
      <footer>
        ...
        <div id="art-archive" class="paralax-container cursor-link" data-paralax="95">
          <img class="cursor-link" src="./assets/camera.png" alt="">
